...
const SECTORS: ViseeSector[] = [
  {
    id: 1,
    name: "Visée 1 : Autonomie & Posture Réflexive",
    shortName: "Autonomie",
    icon: Compass,
    ...
    switches: [
      {
        ...
        sub: "Bloquer tous les accès et punir sans expliquer",
        isOptimal: false,
      ...
      },
      {
        ...
        isOptimal: true,
        feedbackEffect: "✓ Jauge chargée ! L'élève apprend à agir de façon autonome et responsable face aux techniques (p. 26).",
      },
      {
        id: 3,
        label: "Levier 3 : Laisser-faire consumériste passif",
        sub: "Tolérer la délégation aveugle de tous les travaux",
        isOptimal: false,
  ...
  {
    id: 2,
    name: "Visée 2 : Raisonnement & Pensée Scientifique",
    shortName: "Raisonnement",
    icon: Cpu,
    ...
    switches: [
      {
        ...
        isOptimal: true,
        feedbackEffect: "✓ Jauge chargée ! Développement de la pensée critique et de la méthode scientifique (p. 26).",
      },
      {
        id: 2,
        ...
        isOptimal: false,
        feedbackEffect: "Court-circuit : Consommation impulsive sans démarche d'investigation ni rigueur.",
      },
      {
        id: 3,
        label: "Levier 3 : Abandonner le projet de serre",
        sub: "Conclure que l'électronique est inaccessible",
        isOptimal: false,
  ...
  {
    id: 3,
    name: "Visée 3 : Créativité & Conception Ingénieuse",
    ...
    switches: [
      {
        ...
        sub: "Pénaliser la mobilité active des élèves",
        isOptimal: false,
        feedbackEffect: "Court-circuit : Mesure punitive qui tue l'initiative éco-citoyenne.",
      },
      {
        id: 2,
        label: "Levier 2 : Télécharger un modèle sans adaptation",
        sub: "Copier sans s'adapter aux dimensions du hall",
        isOptimal: false,
        feedbackEffect: "Court-circuit : Reproduction sans démarche de conception créative.",
      },
      {
        id: 3,
        ...
        isOptimal: true,
        feedbackEffect: "✓ Jauge chargée ! L'ingéniosité et la créativité résolvent un besoin concret (p. 26).",
      },
    ],
  },
  {
    id: 4,
    name: "Visée 4 : Coopération & Intelligence Collective",
    ...
    switches: [
      {
        ...
        isOptimal: true,
        feedbackEffect: "✓ Jauge chargée ! Coopération solidaire, communication et responsabilité partagée (p. 26).",
      },
      {
        id: 2,
        label: "Levier 2 : Isoler les élèves chacun sur un écran",
        sub: "Supprimer tout travail d'équipe",
        isOptimal: false,
        feedbackEffect: "Court-circuit : Élimine l'apprentissage social et la coopération.",
      },
      {
        id: 3,
        label: "Levier 3 : Encourager la compétition individuelle",
        sub: "Seule l'équipe la plus rapide reçoit une note",
        isOptimal: false,
        feedbackEffect: "Court-circuit : Compétition toxique opposée à la solidarité du Tronc Commun.",
      },
    ],
  },
  {
    id: 5,
    name: "Visée 5 : Éco-citoyenneté & Sobriété Technologique",
    shortName: "Éco-citoyenneté",
    icon: Leaf,
    ...
    switches: [
      {
        ...
        sub: "Rachat complet de matériel neuf",
        isOptimal: false,
        feedbackEffect: "Court-circuit : Gaspillage et pollution électronique massive.",
      },
      {
        id: 2,
        label: "Levier 2 : Laisser pourrir dans une armoire",
        sub: "Stocker passivement sans réparer",
        isOptimal: false,
      ...
      },
      {
        ...
        isOptimal: true,
        feedbackEffect: "✓ Jauge chargée ! Sobriété numérique, allongement du cycle de vie et éco-responsabilité (p. 26).",
      },
    ],
  },
];
