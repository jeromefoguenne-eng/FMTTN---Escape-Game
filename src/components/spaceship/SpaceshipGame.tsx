...
const ZONES: ZoneInfo[] = [
  {
    id: 1,
    name: "Atelier de Fabrication Spatiale",
    theme: "Niveau 1 • Matières, Matériaux & Ouvrages (p. 99-100)",
    pageRef: 99,
    icon: Wrench,
    color: "from-blue-900/40 to-slate-900 border-blue-600/40 hover:border-blue-400",
    badgeColor: "bg-blue-500/20 text-blue-300 border-blue-500/30",
    description: "Les jeunes passagers doivent fabriquer des pièces de secours mais confondent matières premières, matériaux et consommables. Régulez l'atelier !",
    mapX: 71.0,
    mapY: 67.0,
    mapLabel: "Atelier",
    shortChoice: "N1 • Matériaux (p. 99-100)",
    wireframeColor: "border-blue-500 bg-blue-950/80 text-blue-300",
  },
  {
    id: 2,
    name: "Bio-Dôme & Serre Connectée IoT",
    theme: "Niveau 2 • Démarche Technologique & Serre IoT (p. 22-25)",
    pageRef: 24,
    icon: Leaf,
    color: "from-emerald-900/40 to-slate-900 border-emerald-600/40 hover:border-emerald-400",
    badgeColor: "bg-emerald-500/20 text-emerald-300 border-emerald-500/30",
    description: "La régulation climatique de la serre est en panne. Rétablissez la démarche de projet et la chaîne d'information numérique (Capteurs ➔ Traitement ➔ Actionneurs).",
    mapX: 50.0,
    mapY: 25.0,
    mapLabel: "Bio-Dôme",
    shortChoice: "N2 • Serre IoT (p. 22-25)",
    wireframeColor: "border-teal-400 bg-teal-950/80 text-teal-300",
  },
  {
    id: 3,
    name: "Cœur Robotique & Exploration",
    theme: "Niveau 3 • Logigrammes, Algorithmes & Thymio (p. 50, 56, 101)",
    pageRef: 50,
    icon: Cpu,
    color: "from-amber-900/40 to-slate-900 border-amber-600/40 hover:border-amber-400",
    badgeColor: "bg-amber-500/20 text-amber-300 border-amber-500/30",
    description: "Le robot d'inspection naviguant dans les conduits du réacteur tourne en rond. Déboguez son logigramme et son programme par blocs selon la norme FMTTN.",
    mapX: 76.0,
    mapY: 10.0,
    mapLabel: "Réacteur",
    shortChoice: "N3 • Robotique (p. 50-56)",
    wireframeColor: "border-amber-500 bg-amber-950/80 text-amber-300",
  },
  {
    id: 4,
    name: "Cyber-Centre & Données des Passagers",
    theme: "Niveau 4 • Protection RGPD, Médias & Anti-Phishing (p. 24, 100)",
    pageRef: 100,
    icon: Smartphone,
    color: "from-purple-900/40 to-slate-900 border-purple-600/40 hover:border-purple-400",
    badgeColor: "bg-purple-500/20 text-purple-300 border-purple-500/30",
    description: "Panique sur le réseau de bord ! Les passagers fuient leurs données civiles. Reclassez les flux selon les 5 strates officielles et neutralisez le hameçonnage.",
    mapX: 33.0,
    mapY: 44.0,
    mapLabel: "Cyber-Centre",
    shortChoice: "N4 • RGPD & Médias (p. 100)",
    wireframeColor: "border-purple-400 bg-purple-950/80 text-purple-300",
  },
  {
    id: 5,
    name: "Pont de Commandement Stellaire",
    theme: "Niveau 5 • Les 5 Visées Annuelles du Tronc Commun (p. 26)",
    pageRef: 26,
    icon: GraduationCap,
    color: "from-indigo-900/40 to-slate-900 border-indigo-600/40 hover:border-indigo-400",
    badgeColor: "bg-indigo-500/20 text-indigo-300 border-indigo-500/30",
    description: "L'ordinateur de trajectoire n'engagera le cap vers la nouvelle planète que si les 5 Visées transversales du Tronc Commun sont validées.",
    mapX: 18.0,
    mapY: 60.0,
    mapLabel: "Passerelle",
    shortChoice: "N5 • Les 5 Visées (p. 26)",
