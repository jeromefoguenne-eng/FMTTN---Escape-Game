...
const ZONES: ZoneInfo[] = [
  {
    ...
    theme: "Matières, Matériaux & Objets de Survie (p. 99)",
    pageRef: 99,
    icon: Wrench,
    color: "from-blue-900/40 to-slate-900 border-blue-600/40 hover:border-blue-400",
    badgeColor: "bg-blue-500/20 text-blue-300 border-blue-500/30",
    description: "Les jeunes passagers doivent fabriquer des pièces de secours mais confondent matières premières et matériaux. Régulez l'atelier !",
    mapX: 71.0,
    mapY: 67.0,
    mapLabel: "Atelier",
    shortChoice: "Matériaux (p. 99)",
  ...
  },
  {
    ...
    mapX: 18.0,
    mapY: 82.0,
    mapLabel: "Commandement",
    shortChoice: "5 Visées (p. 26)",
    wireframeColor: "border-cyan-400 bg-cyan-950/80 text-cyan-300",
  },
];
