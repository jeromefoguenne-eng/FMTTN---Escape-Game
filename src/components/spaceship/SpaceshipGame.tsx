...
const ZONES: ZoneInfo[] = [
  {
    ...
    description: "Structurez l'environnement informatique : classez composants physiques, logiciels, formats de fichiers et cloud, puis remédiez à la confusion d'un élève sur la mémoire vive.",
    mapX: 71.0,
    mapY: 67.0,
    mapLabel: "Système",
  ...
  },
  {
    ...
    description: "Rétablissez la chronologie de recherche documentaire critique sur le Web et la chaîne d'information cyber-physique (Capteurs ➔ Traitement ➔ Actionneurs).",
    mapX: 50.0,
    mapY: 25.0,
  ...
  },
  {
    ...
    description: "Déboguez le logigramme normalisé et différenciez rigoureusement Algorithme et Programme, puis programmez le robot Thymio sous Scratch.",
    mapX: 76.0,
    mapY: 10.0,
    mapLabel: "Robotique",
  ...
  },
  {
    ...
    description: "Reclassez les traces selon les 5 strates d'identité numérique du référentiel, neutralisez l'attaque d'ingénierie sociale et mobilisez le cadre CSEM.",
    mapX: 33.0,
    mapY: 44.0,
  ...
  },
  {
    ...
    description: "Analysez 5 situations authentiques de classe de numérique et choisissez la régulation didactique conforme aux attendus du Tronc Commun.",
    mapX: 18.0,
    mapY: 60.0,
